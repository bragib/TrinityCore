...
bool showBuyList(Player *player, Creature *_creature, uint32 showFromId = 0)
{
 ...
 AddGossipItemFor(ICON_GOSSIP_TABARD, comment, GOSSIP_SENDER_MAIN,
 ...
 AddGossipItemFor(ICON_GOSSIP_BALOONDOTS, MSG_GOSSIP_NEXTPAGE, GOSSIP_SENDER_MAIN,
 guildhouseId + OFFSET_SHOWBUY_FROM);
 }

 SendGossipMenuFor(DEFAULT_GOSSIP_MESSAGE, _creature->GetGUID());
...
void sellGuildhouse(Player *player, Creature *_creature)
{
 ...
 {
 AddGossipItemFor(ICON_GOSSIP_BALOON, MSG_GOSSIP_TELE, GOSSIP_SENDER_MAIN, ACTION_TELE);
 ...
 AddGossipItemFor_EXTENDED(ICON_GOSSIP_GOLD, MSG_GOSSIP_SELL, GOSSIP_SENDER_MAIN, ACTION_SELL_GUILDHOUSE, MSG_SELL_CONFIRM, 0, false);

 }
 else
 {
 //show additional menu for guild leader
 AddGossipItemFor(ICON_GOSSIP_GOLD, MSG_GOSSIP_BUY, GOSSIP_SENDER_MAIN, ACTION_SHOW_BUYLIST);
 }
 }
